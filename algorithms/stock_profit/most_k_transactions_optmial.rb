...
# complaxity O(days * transactions)
  ...
  def max_profit
    ...
    for kth_transaction in 1..@num_transactions 
      ...
      for ith_day in 1..@num_days - 1
        ...
        prev_diff = [prev_diff, profit_table[kth_transaction-1][ith_day - 1] - @prices[ith_day - 1]].max
        profit_table[kth_transaction][ith_day] = [profit_table[kth_transaction][ith_day-1], @prices[ith_day] + prev_diff].max
      end
    end
